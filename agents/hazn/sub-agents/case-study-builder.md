...
After files are confirmed, ask: **Public or private?**

- **Public** → copy to `/home/rizki/landing-pages/audits/{client-slug}-case-study/` and push to `main`
- **Private** → copy to `/home/rizki/autonomous-proposals/{client-slug}/` and push to `main`

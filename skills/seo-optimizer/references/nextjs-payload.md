# SEO Optimization — Next.js + Payload CMS

Reference for projects using Next.js (App Router) with Payload CMS as the content backend.
...
Marks which content is optimized for voice assistants and AI reading:
